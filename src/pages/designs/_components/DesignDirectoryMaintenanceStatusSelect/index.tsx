...
import { MaintainedType } from '@site/src/data/designs';
...
function DesignDirectoryMaintenanceStatusSelect(
...
export default React.forwardRef(DesignDirectoryMaintenanceStatusSelect);
